...
begin
  ...
  begin
    ...
    writeln ('-------------------------------------------------------------------------------------------------------------------------------------|');
    writeln('|  ', numbering, '  |     ', packets[searchIndex].np, '       |     ', packets[searchIndex].berat, '     |          ', packets[searchIndex].nama, '             |         ', packets[searchIndex].tujuan, '           |         ', packets[searchIndex].kota, '         |         ', packets[searchIndex].biaya, '         |           ', packets[searchIndex].kirim, '        |');
    write   ('-------------------------------------------------------------------------------------------------------------------------------------');
  end;
  end
  else
